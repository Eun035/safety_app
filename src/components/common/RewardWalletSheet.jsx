            ...
            {isOpen && (
                <motion.div key="modal-root" className="fixed inset-0 z-[2500] pointer-events-none flex flex-col justify-end items-center px-0 sm:px-4">
                    ...
                    <motion.div
                        ...
                        className="pointer-events-auto relative w-full max-w-md bg-[#0a0c0f] rounded-t-[2.5rem] shadow-[0_-20px_50px_rgba(0,0,0,0.8)] border-t border-amber-500/40 overflow-hidden flex flex-col max-h-[92vh]"
                    >
                            {/* Drag Handle */}
                            <div
                                onClick={onClose}
